...
/// @fn int ObtenerCadenaDeNumeros(char[], char[], char[], int)
/// @brief funcion que obtiene solo numero en una cadena de caracteres
/// @param texto Puntero a char de la cadena
/// @param mensaje puntero a char donde esta el primer mensaje de pedido
/// @param mensajeError puntero a char donde esta el mensaje de error
/// @param reintentos parametro por valor de un entero
/// @return Devuelve 0 si hay un error o 1 si es correcto
int ObtenerCadenaDeNumeros(char texto[], char mensaje[], char mensajeError[], int reintentos);
